...
%% time complexity of sequential splitting as a function of L with Brute-Force
...
%% Plot for the running time

figure("Name","Runtime of sequential splitting using FFT and brute-force", ...
