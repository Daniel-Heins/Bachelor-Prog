...
figure("Name","Strang Splitting Fehler", ...
    "NumberTitle","off","Position",[100, 100, 800, 600]);
%c onstants for nice plots
    C_1 = 10;      
    C_2 = 0.01;     
...
legend("C_1 tau  ,C_1 ∊ ℝ " ...
    ,"Strang Splitting Fehler","C_2 tau^2  ,C_2 ∊ ℝ ","Location","northwest");
